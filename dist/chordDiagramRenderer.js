...
System.register(['lodash', './external/d3.v3.min', './chordDataMapper', './chordDataReader'], function (_export, _context) {
  ...
  function renderChordDiagram(container, chordDiagramDivId, w, h) {
    ...
    var data = [{ "leavingPage": "Deal", "enteringPage": "Facility", "count": "468" }, { "leavingPage": "Deal", "enteringPage": "Security Package", "count": "163" }, { "leavingPage": "Deal", "enteringPage": "Borrowing Base", "count": "34" }, { "leavingPage": "Facility", "enteringPage": "Deal", "count": "342" }, { "leavingPage": "Facility", "enteringPage": "Security Package", "count": "120" }, { "leavingPage": "Facility", "enteringPage": "Borrowing Base", "count": "13" }, { "leavingPage": "Security Package", "enteringPage": "Deal", "count": "154" }, { "leavingPage": "Security Package", "enteringPage": "Facility", "count": "24" }, { "leavingPage": "Security Package", "enteringPage": "Borrowing Base", "count": "4" }, { "leavingPage": "Borrowing Base", "enteringPage": "Deal", "count": "54" }, { "leavingPage": "Borrowing Base", "enteringPage": "Facility", "count": "9" }, { "leavingPage": "Borrowing Base", "enteringPage": "Borrowing Base", "count": "0" }];
    ...
    function drawChords(matrix, mmap) {
      ...
      function chordTip(d) {
        ...
        var p = d3.format(".1%"),
            q = d3.format(",.2f");
        return "Chord Info:<br/>" + "Leaving " + d.sname + " to " + d.tname + ": " + d.svalue + "<br/>" + p(d.svalue / d.stotal) + " of " + d.sname + "'s leaving  (" + d.stotal + ")<br/>" + p(d.svalue / d.mtotal) + " of total transitions (" + d.mtotal + ")<br/>" + "<br/>" + "Entering " + d.tname + " from " + d.sname + ": " + d.tvalue + "<br/>" + p(d.tvalue / d.ttotal) + " of " + d.tname + "'s entering (" + d.ttotal + ")<br/>" + p(d.tvalue / d.mtotal) + " of total transitions (" + d.mtotal + ")";
      }

      function groupTip(d) {
        var p = d3.format(".1%"),
            q = d3.format(",.2f");
        return "Group Info:<br/>" + d.gname + " : " + d.gvalue + " transitions <br/>" + p(d.gvalue / d.mtotal) + " of total transitions (" + d.mtotal + ")";
      }
    ...
    function build() {
      ...
      mpr.addValuesToMap("leavingPage").setFilter(function (row, a, b) {
